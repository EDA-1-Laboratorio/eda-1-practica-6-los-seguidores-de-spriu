    ...
    while ((c = getchar()) != EOF) {
        switch (c) {
            ...
            if (!full(&a)) {
                ...
                printf("Limite de 6 ordenes alcanzado en la fila a. \n");
            ]
            break;
            ...
            if (!full(&b)) {
                ...
                printf("Limite de 6 ordenes alcanzado en la fila b. \n");
            }
            break;
            case 'c':
            if (!empty(&a)) {
                printf("El platillo que sigue para servirse en 'a' es el %u/n ", head(&a));
            }
            break
        }    
    }
